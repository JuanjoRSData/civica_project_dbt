...
renamed AS (
    SELECT
        ...
        TRY_CAST(SUBSTRING(SPLIT_PART(temperatura_acuario, '-', 2), 1, 3) AS INT) AS temperatura_maxima_origen,
        ...
        TRY_CAST(SUBSTRING(SPLIT_PART(temperatura_origen, '-', 2), 1, 3) AS INT) AS temperatura_acuario_maximo,
